...
namespace WaitSetData {
	...
	class OS_EXAMPLE_API MsgTypeSupportMetaHolder : public ::DDS::OpenSplice::TypeSupportMetaHolder
	{
	public:
	...
	class OS_EXAMPLE_API MsgTypeSupport : public virtual MsgTypeSupportInterface,
	...
	private:
		...
		MsgTypeSupport & operator= (const MsgTypeSupport &);
	};

	typedef MsgTypeSupportInterface_var MsgTypeSupport_var;
	typedef MsgTypeSupportInterface_ptr MsgTypeSupport_ptr;

	class OS_EXAMPLE_API MsgDataWriter_impl : public virtual MsgDataWriter,
	...
	private:
		...
		MsgDataWriter_impl & operator= (const MsgDataWriter_impl &);
	};

	class OS_EXAMPLE_API MsgDataReader_impl : public virtual MsgDataReader,
	...
	private:
		MsgDataReader_impl(const MsgDataReader_impl &);
		MsgDataReader_impl & operator= (const MsgDataReader_impl &);
	...
	class OS_EXAMPLE_API MsgDataReaderView_impl : public virtual MsgDataReaderView,
	...
	private:
		MsgDataReaderView_impl(const MsgDataReaderView_impl &);

		MsgDataReaderView_impl & operator= (const MsgDataReaderView_impl &);
	};
